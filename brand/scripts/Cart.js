...
class Cart {
  ...
  _renderItem(product) {
    ...
    $itemQuantity.append($(`<input type="number" name="quantity" data-id="${product.id_product}" class="td_quality_ink" value="${product.quantity}" min="1" max="100">`));
    $itemQuantity.click ('input', (e) => {
